...
def train_network(filled_accumulators, training_normals):
    ...
    #save model 
    model.save("accumulator_filled_after_reorientation_Bunny_MS3.h5")
...
def main():
    ...
    np.savez_compressed("accumulator_filled_without_PCA_with_multiscale_Bunny", bunny_accumulators = accumulator_filled)
    accumulator_filled = np.load("accumulator_filled_without_PCA_with_multiscale_Bunny.npz")['bunny_accumulators']
    ...
    #load
    model = load_model("accumulator_filled_after_reorientation_Bunny_MS3.h5")
